...
func (s *Service) evaluatePrediction(now time.Time, prediction api.HardwareRiskPrediction, spec api.PredictionModelSpec) (api.PredictionOutcomeEvaluation, error) {
	...
	row := api.PredictionOutcomeEvaluation{
		...
		NodeIP: prediction.NodeIP, ScopeEventType: prediction.ScopeEventType, ModelName: prediction.ModelName,
		DataCenterID: prediction.DataCenterID, DriverVersion: prediction.DriverVersion, SliceContract: prediction.SliceContract,
		HorizonMinutes: horizon, Probability: prediction.Probability,
