...
func promotionDecisionReport(source DualTrackValidationReport) PromotionDecisionReport {
	...
	report.Gates = append(report.Gates,
		...
		promotionGate("human_feedback_manifest", source.Readiness.HumanFeedbackStatus == "feedback_ready", source.Readiness.HumanFeedbackStatus == "exploratory_ready", source.Readiness.HumanFeedbackVersion, source.Readiness.HumanFeedbackSHA256, "human feedback manifest is not ready for validation binding"),
