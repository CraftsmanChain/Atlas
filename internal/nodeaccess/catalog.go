...
func skillCatalog() []SkillDefinition {
	return []SkillDefinition{
		{
			ID: "atlas-node-evidence", Version: "v0.5.0", Class: "evidence", Status: "recovery_aware_collection",
	...
	return []AlertEvidencePolicy{
		{
			...
			IssueTypes: []string{
				"row_remap_failure", "uncorrectable_remapped_rows", "correctable_remapped_rows_growth",
