...
type HealthSummary = { total: number; scored: number; unknown: number; fallback_gpus: number; inconsistent_gpus: number; average_score: number; by_level: Record<string, number>; by_confidence: Record<string, number>; latest_run: { id: number; rule_version: string; status: string; rule_hit_count: number; finished_at?: string } | null };
