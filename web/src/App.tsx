...
function Models({ tx, view, lang, assets }: { tx: Tx; view: string; lang: string; assets: GPUAsset[] }) {
  ...
  const trainBaselineModels = async (algorithm: 'logistic_regression' | 'gradient_boosted_stumps' | 'anomaly_filtered_logistic' = 'logistic_regression') => {
