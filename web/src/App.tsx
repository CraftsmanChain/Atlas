  ...
  if (isPredictionView) {
    ...
    return <div className="grid prediction-page">
      ...
      {observabilityRanking ? <Card className="span-12">
        ...
        <p className="node-access-note">{tx('下表保留 v1 的 max-gap 主策略字段，便于对照已发布报告；各策略完整结果在下载报告的 policy_results 中。', 'The table below preserves the v1 max-gap primary-policy fields for comparison with the released report; complete per-policy results are available under policy_results in the downloaded report.')}</p>
