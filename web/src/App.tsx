...
type MatrixReadinessReport = { matrix_key: string; policy: Record<string, number>; ready_strata: number; insufficient_strata: number; deficits?: CohortReadinessDeficit[]; recommended_next_run?: string[]; strata: CohortStratumReadiness[] };
