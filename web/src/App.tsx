    ...
    return <div className="grid prediction-page">
      ...
      {validationReadiness ? <Card className="span-12">
        ...
        <div className="issue-categories quality-ledger">
          ...
          <div><b>{tx('7 天 Challenger', '7d challenger')}</b><strong>{(validationReadiness.challenger_confidence_status || validationReadiness.challenger_status).toUpperCase()}</strong><small>{validationReadiness.seven_day_rows} ROWS · {validationReadiness.seven_day_nodes} NODES · {validationReadiness.seven_day_positives} POS</small></div>
