    ...
    return <div className="grid prediction-page">
      ...
      {warningTab === 'feedback-pack' ? <Card id="prediction-feedback-package" className="span-12">
        ...
        <div className="issue-categories quality-ledger compact-ledger">
          <div><b>{tx('最新特征请求', 'Latest feature request')}</b><strong>{compactWorkflowStatus(latestFeatureStatus)}</strong><small>{latestFeedbackFeatureRequest?.version || 'manual-feedback-feature-request-v3'}</small></div>
